...
export const StarredIcon: FunctionComponent<GlyphProps> = (props) => {
  ...
  const LazyAdsIcon = useLazyComponent(
    () =>
      import(
        /* webpackChunkName: "ADS-StarredIcon" */ '@atlaskit/icon/core/star-starred'
      ),
