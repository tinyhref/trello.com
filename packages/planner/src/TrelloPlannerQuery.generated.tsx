...
export type TrelloPlannerQuery = (
  { __typename: 'Query' }
  & { trello: (
    { __typename: 'TrelloQueryApi' }
    & { member?: Types.Maybe<(
      { __typename: 'TrelloMember' }
      & Pick<Types.TrelloMember, 'id' | 'confirmed'>
      & { planner?: Types.Maybe<(
...
/**
 * __useTrelloPlannerQuery__
 *
 * To run a query within a React component, call `useTrelloPlannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useTrelloPlannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTrelloPlannerQuery({
 *   variables: {
 *      end: // value for 'end'
 ...
 * });
 */
export function useTrelloPlannerQuery(
  baseOptions: TrelloQueryHookOptions<
    TrelloPlannerQuery,
    TrelloPlannerQueryVariables
  > &
    (
      | { variables: TrelloPlannerQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const isQuickLoading = useQuickLoad({
    waitOn: baseOptions?.waitOn || ['None'],
    document: TrelloPlannerDocument,
...
export function useTrelloPlannerLazyQuery(
  ...
  return Apollo.useLazyQuery<TrelloPlannerQuery, TrelloPlannerQueryVariables>(
    TrelloPlannerDocument,
    options,
  );
}
export function useTrelloPlannerSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type TrelloPlannerQueryHookResult = ReturnType<
  typeof useTrelloPlannerQuery
>;
export type TrelloPlannerLazyQueryHookResult = ReturnType<
  typeof useTrelloPlannerLazyQuery
>;
export type TrelloPlannerSuspenseQueryHookResult = ReturnType<
  typeof useTrelloPlannerSuspenseQuery
>;
export type TrelloPlannerQueryResult = Apollo.QueryResult<
  TrelloPlannerQuery,
  TrelloPlannerQueryVariables
>;
