...
export type TrelloCreateCalendarEventMutationFn = Apollo.MutationFunction<
  TrelloCreateCalendarEventMutation,
  TrelloCreateCalendarEventMutationVariables
>;

/**
 * __useTrelloCreateCalendarEventMutation__
 *
 * To run a mutation, you first call `useTrelloCreateCalendarEventMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTrelloCreateCalendarEventMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [trelloCreateCalendarEventMutation, { data, loading, error }] = useTrelloCreateCalendarEventMutation({
 *   variables: {
 *      end: // value for 'end'
 *      event: // value for 'event'
 *      plannerCalendarId: // value for 'plannerCalendarId'
 *      providerAccountId: // value for 'providerAccountId'
 *      start: // value for 'start'
 *   },
 * });
 */
export function useTrelloCreateCalendarEventMutation(
  ...
  return Apollo.useMutation<
    TrelloCreateCalendarEventMutation,
    TrelloCreateCalendarEventMutationVariables
  >(TrelloCreateCalendarEventDocument, options);
}
export type TrelloCreateCalendarEventMutationHookResult = ReturnType<
  typeof useTrelloCreateCalendarEventMutation
>;
export type TrelloCreateCalendarEventMutationResult =
  Apollo.MutationResult<TrelloCreateCalendarEventMutation>;
export type TrelloCreateCalendarEventMutationOptions =
