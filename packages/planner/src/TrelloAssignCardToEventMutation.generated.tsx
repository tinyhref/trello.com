...
export type TrelloAssignCardToEventMutationFn = Apollo.MutationFunction<
  TrelloAssignCardToEventMutation,
  TrelloAssignCardToEventMutationVariables
>;

/**
 * __useTrelloAssignCardToEventMutation__
 *
 * To run a mutation, you first call `useTrelloAssignCardToEventMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTrelloAssignCardToEventMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [trelloAssignCardToEventMutation, { data, loading, error }] = useTrelloAssignCardToEventMutation({
 *   variables: {
 *      cardId: // value for 'cardId'
 *      plannerCalendarId: // value for 'plannerCalendarId'
 *      position: // value for 'position'
 *      providerAccountId: // value for 'providerAccountId'
 *      providerEventId: // value for 'providerEventId'
 *   },
 * });
 */
export function useTrelloAssignCardToEventMutation(
  ...
  return Apollo.useMutation<
    TrelloAssignCardToEventMutation,
    TrelloAssignCardToEventMutationVariables
  >(TrelloAssignCardToEventDocument, options);
}
export type TrelloAssignCardToEventMutationHookResult = ReturnType<
  typeof useTrelloAssignCardToEventMutation
>;
export type TrelloAssignCardToEventMutationResult =
  Apollo.MutationResult<TrelloAssignCardToEventMutation>;
export type TrelloAssignCardToEventMutationOptions = Apollo.BaseMutationOptions<
  TrelloAssignCardToEventMutation,
  TrelloAssignCardToEventMutationVariables
>;
