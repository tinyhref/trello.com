      ...
      & {
        ...
        plannerCalendarMutated?: Types.Maybe<
          ...
          | (
            ...
            & Pick<Types.TrelloPlannerCalendarDeleted, 'id'>
          )
        >,
      }
    )> }
...
export type TrelloTogglePlannerCalendarMutationFn = Apollo.MutationFunction<
  TrelloTogglePlannerCalendarMutation,
  TrelloTogglePlannerCalendarMutationVariables
>;

/**
 * __useTrelloTogglePlannerCalendarMutation__
 *
 * To run a mutation, you first call `useTrelloTogglePlannerCalendarMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTrelloTogglePlannerCalendarMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [trelloTogglePlannerCalendarMutation, { data, loading, error }] = useTrelloTogglePlannerCalendarMutation({
 *   variables: {
 ...
 * });
 */
export function useTrelloTogglePlannerCalendarMutation(
  ...
  return Apollo.useMutation<
    TrelloTogglePlannerCalendarMutation,
    TrelloTogglePlannerCalendarMutationVariables
  >(TrelloTogglePlannerCalendarDocument, options);
}
export type TrelloTogglePlannerCalendarMutationHookResult = ReturnType<
  typeof useTrelloTogglePlannerCalendarMutation
>;
export type TrelloTogglePlannerCalendarMutationResult =
  Apollo.MutationResult<TrelloTogglePlannerCalendarMutation>;
export type TrelloTogglePlannerCalendarMutationOptions =
