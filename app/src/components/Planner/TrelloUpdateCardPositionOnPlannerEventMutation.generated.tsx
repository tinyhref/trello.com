...
export type TrelloUpdateCardPositionOnPlannerEventMutationFn =
  Apollo.MutationFunction<
    TrelloUpdateCardPositionOnPlannerEventMutation,
    TrelloUpdateCardPositionOnPlannerEventMutationVariables
  >;

/**
 * __useTrelloUpdateCardPositionOnPlannerEventMutation__
 *
 * To run a mutation, you first call `useTrelloUpdateCardPositionOnPlannerEventMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useTrelloUpdateCardPositionOnPlannerEventMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [trelloUpdateCardPositionOnPlannerEventMutation, { data, loading, error }] = useTrelloUpdateCardPositionOnPlannerEventMutation({
 *   variables: {
 *      plannerCalendarEventCardId: // value for 'plannerCalendarEventCardId'
 *      position: // value for 'position'
 *   },
 * });
 */
export function useTrelloUpdateCardPositionOnPlannerEventMutation(
  ...
  return Apollo.useMutation<
    TrelloUpdateCardPositionOnPlannerEventMutation,
    TrelloUpdateCardPositionOnPlannerEventMutationVariables
  >(TrelloUpdateCardPositionOnPlannerEventDocument, options);
}
export type TrelloUpdateCardPositionOnPlannerEventMutationHookResult =
  ReturnType<typeof useTrelloUpdateCardPositionOnPlannerEventMutation>;
export type TrelloUpdateCardPositionOnPlannerEventMutationResult =
  Apollo.MutationResult<TrelloUpdateCardPositionOnPlannerEventMutation>;
export type TrelloUpdateCardPositionOnPlannerEventMutationOptions =
