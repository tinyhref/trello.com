...
const defaultOptions = {"context":{"operationName":"SingleBoardData","document":SingleBoardDataDocument}} as const;
 ...
 * });
 */
export function useSingleBoardDataQuery(
  baseOptions: TrelloQueryHookOptions<
    SingleBoardDataQuery,
    SingleBoardDataQueryVariables
  > &
    (
      | { variables: SingleBoardDataQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const isQuickLoading = useQuickLoad({
    waitOn: baseOptions?.waitOn || ['None'],
    document: SingleBoardDataDocument,
  ...
  const result = Apollo.useQuery<
    SingleBoardDataQuery,
    SingleBoardDataQueryVariables
  >(SingleBoardDataDocument, options);
...
export function useSingleBoardDataLazyQuery(
...
export function useSingleBoardDataSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type SingleBoardDataQueryHookResult = ReturnType<
  typeof useSingleBoardDataQuery
>;
export type SingleBoardDataLazyQueryHookResult = ReturnType<
  typeof useSingleBoardDataLazyQuery
>;
export type SingleBoardDataSuspenseQueryHookResult = ReturnType<
  typeof useSingleBoardDataSuspenseQuery
>;
export type SingleBoardDataQueryResult = Apollo.QueryResult<
  SingleBoardDataQuery,
  SingleBoardDataQueryVariables
>;
