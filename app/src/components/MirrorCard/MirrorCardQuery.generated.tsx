 ...
 * });
 */
export function useMirrorCardQuery(
  baseOptions: TrelloQueryHookOptions<
    MirrorCardQuery,
    MirrorCardQueryVariables
  > &
    (
      | { variables: MirrorCardQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const isQuickLoading = useQuickLoad({
    waitOn: baseOptions?.waitOn || ['None'],
    document: MirrorCardDocument,
  ...
  const result = Apollo.useQuery<MirrorCardQuery, MirrorCardQueryVariables>(
    MirrorCardDocument,
    options,
  );
...
export function useMirrorCardLazyQuery(
  ...
  return Apollo.useLazyQuery<MirrorCardQuery, MirrorCardQueryVariables>(
    MirrorCardDocument,
    options,
  );
}
export function useMirrorCardSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | TrelloSuspenseQueryHookOptions<MirrorCardQuery, MirrorCardQueryVariables>,
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<MirrorCardQuery, MirrorCardQueryVariables>(
    MirrorCardDocument,
    options,
  );
}
export type MirrorCardQueryHookResult = ReturnType<typeof useMirrorCardQuery>;
export type MirrorCardLazyQueryHookResult = ReturnType<
  typeof useMirrorCardLazyQuery
>;
export type MirrorCardSuspenseQueryHookResult = ReturnType<
  typeof useMirrorCardSuspenseQuery
>;
export type MirrorCardQueryResult = Apollo.QueryResult<
  MirrorCardQuery,
  MirrorCardQueryVariables
>;
