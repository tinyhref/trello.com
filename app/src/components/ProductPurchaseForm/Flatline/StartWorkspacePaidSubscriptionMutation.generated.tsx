...
export type StartWorkspacePaidSubscriptionMutation = (
  { __typename: 'Mutation' }
  & { startWorkspacePaidSubscription?: Types.Maybe<(
...
export type StartWorkspacePaidSubscriptionMutationFn = Apollo.MutationFunction<
  StartWorkspacePaidSubscriptionMutation,
  StartWorkspacePaidSubscriptionMutationVariables
>;

/**
 * __useStartWorkspacePaidSubscriptionMutation__
 *
 * To run a mutation, you first call `useStartWorkspacePaidSubscriptionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useStartWorkspacePaidSubscriptionMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [startWorkspacePaidSubscriptionMutation, { data, loading, error }] = useStartWorkspacePaidSubscriptionMutation({
 *   variables: {
 ...
 * });
 */
export function useStartWorkspacePaidSubscriptionMutation(
  ...
  return Apollo.useMutation<
    StartWorkspacePaidSubscriptionMutation,
    StartWorkspacePaidSubscriptionMutationVariables
  >(StartWorkspacePaidSubscriptionDocument, options);
}
export type StartWorkspacePaidSubscriptionMutationHookResult = ReturnType<
  typeof useStartWorkspacePaidSubscriptionMutation
>;
export type StartWorkspacePaidSubscriptionMutationResult =
  Apollo.MutationResult<StartWorkspacePaidSubscriptionMutation>;
export type StartWorkspacePaidSubscriptionMutationOptions =
